 ...
 * @author estadm
 */
public class SeleccionDeDeposito extends javax.swing.JFrame {

    /**
     * Creates new form ConsultarEstadoDeCuenta
     */
    public SeleccionDeDeposito() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipo de depósito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionDeDeposito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionDeDeposito().setVisible(true);
            }
        });
    }
